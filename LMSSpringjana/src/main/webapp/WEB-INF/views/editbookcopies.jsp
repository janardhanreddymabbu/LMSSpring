...
<h3>List of Books  <a href="viewlibrarybranch"><input type="button" value="Cancel" name="cancel"/></a></h3>
<div class="row">
	<div class="col-md-9">
	...
	<th>Update Copies</th>
			...
			<td><button type="button" class="btn btn-sm btn-primary"  data-toggle="modal" data-target="#myModal1"
							href='managecopies?bookId=<%=b.getBookId()%>&branchId=<%=b.getBranchId()%>&noofCopies=<%=b.getNoOfCopies()%>'">Update Copies</button></td>
