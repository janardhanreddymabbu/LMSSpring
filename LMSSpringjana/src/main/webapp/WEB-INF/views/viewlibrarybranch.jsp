...
<h3>List of LibraryBranchs <a href="librarian"><input type="button" value="go back!" name="cancel"/></a></h3> 
<body>
${message}<br/>
<div class="row">
	<div class="col-md-9">
	...
	<th>Manage Book Copies</th>
			...
			<td ><%=b.getBranchAddress() %></td>
					...
					onclick="javascript:location.href='editbookcopies?BranchId=<%=b.getBranchId()%>'">Manage Book Copies</button></td>	
				</tr>
				<%
					}
				%>
