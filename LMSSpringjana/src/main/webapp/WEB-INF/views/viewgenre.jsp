...
<h3>List of Genres  <a href="admin"><input type="button" value="Cancel" name="cancel"/></a></h3>
			...
			<%
				...
				<tr>
					...
					<td><button type="button" class="btn btn-sm btn-primary"  data-toggle="modal" data-target="#myModal1"
							href='editgenre?genreId=<%=g.getGenre_id()%>'">EDIT</button></td>
					<td><button type="button" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#myModal1"
					href='deletegenre?genreId=<%=g.getGenre_id()%>'">DELETE</button></td>	
				</tr>
				<%
					}
				%>
