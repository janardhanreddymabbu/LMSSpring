...
<form action="searchAuthor" >
		<input type="text"  id="searchString" placeholder="Enter Authorname" onkeypress="searchAuthors()"/>
	</form>

<%@ include file="include.html" %>
<h3>List of Authors  <a href="admin.jsp"><input type="button" value="Cancel" name="cancel"/></a></h3> 
<body>
${message}<br/>
