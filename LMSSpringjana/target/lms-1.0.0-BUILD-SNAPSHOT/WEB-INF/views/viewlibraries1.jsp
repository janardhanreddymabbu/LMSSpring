...
<h4>List of LibraryBranchs <a href="borroweraction.jsp?cardNo=<%=b.getCardNo() %>"><input type="button" value="go back!" name="cancel"/></a></h4> 
<body>
${message}<br/>
			...
			<%
				...
				<tr>
					...
					<td><button type="button" class="btn btn-sm btn-primary"  
							onclick="javascript:location.href='borrowerbranchbooks.jsp?BranchId=<%=l.getBranchId()%>&CardNo=<%=b.getCardNo()%>'">Checkout</button></td>
